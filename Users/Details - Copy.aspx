<%@ Page Title="" Language="C#" MasterPageFile="~/Users/UserMasterPage.master" AutoEventWireup="true" CodeFile="Details - Copy.aspx.cs" Inherits="Users_Details" %>
      ...
      <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<%--		<div class="single-infoagile">
                   ...
                   <a href="add_quantity.aspx?pid=<%#Eval("pid") %>&stk=<%#Eval("stock") %>" class="btn btn-primary">Add to cart</a>

                         <a href="Review.aspx?pid=<%#Eval("pid") %>&stk=<%#Eval("stock") %>" class="btn btn-primary">  Review  </a>
