...
public partial class Users_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "select review from Review where pid='"+Request.QueryString["pid"]+"'";
        cmd.Connection = con;
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "update AnalysisReview set count=" + tpc + " where ctype='Positive'";
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "update AnalysisReview set count=" + tnc + " where ctype='Negative'";
        ...
        con.Open();
        cmd = new SqlCommand();
        cmd.CommandText = "update AnalysisReview set count=" + tnec + " where ctype='Neutral'";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        cmd.Connection = con;
        cmd.CommandText = "insert into Review values(@pid,@review,@rdate,@userid,@uname)";
        cmd.Parameters.AddWithValue("@pid", Request.QueryString["pid"].ToString());
        cmd.Parameters.AddWithValue("@review", txtreview.Text);
        cmd.Parameters.AddWithValue("@rdate", DateTime.Now.ToShortDateString());
        cmd.Parameters.AddWithValue("@userid", Session["user_id"].ToString());
        cmd.Parameters.AddWithValue("@uname", uname);
        
        cmd.ExecuteNonQuery();
        con.Close();
        Response.Redirect("Review.aspx?pid=" + Request.QueryString["pid"].ToString());
