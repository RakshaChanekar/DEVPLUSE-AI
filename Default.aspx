...
<head>
    ...
    <style>
      ...
      height: 70px;
      border-radius: 50%;
      background: radial-gradient(circle, #888, #ccc, #f8f8f8);
      display: flex;
    ...
    h2 {
      font-size: 2rem;
      background: linear-gradient(to right, #3a8dde, #005fcb);
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="Registration.aspx" method="get">
						...
						<div class="right-w3l">
							<input type="submit" runat="server" class="form-control" value="New Register" onserverclick="Button2_Click" />
	...
	<!-- header-bottom-->
        ...
        <div class="container">
		   ...
		   <div style="text-align:center">
            <a href="#" class="logo">
                <h2 class="text-center"> Sentiment Analysis And Trend Prediction For e-Commerce Website</h2>
            </a>
			</div>
            ...
            <div class="nav-container">
                ...
                <div class="user-links">
                    ...
                    <a href="#" data-toggle="modal" data-target="#Div1">
                        <i class="fas fa-sign-in-alt"></i> Admin In
                    </a>
				...
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
                             <p style="text-align: justify; color:white; font-size: 30px;">
This System analyzes customer reviews and feedback on an e-commerce website using structured data like ratings, likes/dislikes, and comment activity. It helps identify customer sentiment and predict trending products based on review patterns and user interactions.    </p>
							<%--<p>Get flat
			...
			<div class="carousel-item item2">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
                             <p style="text-align: justify; color:white; font-size: 30px;">
Analyze customer sentiment from feedback sources like reviews and comment.
    </p>
							<%--<p>advanced
			...
			<div class="carousel-item item3">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
                             <p style="text-align: justify; color:white; font-size: 30px;">
Predict emerging trends by identifying shifts in consumer preferences.
    </p>
							<%--<p>Get flat
								<span>10%</span> Cashback</p>
			...
			<div class="carousel-item item4">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
                             <p style="text-align: justify; color:white; font-size: 30px;">
Provide actionable insights to optimize e-commerce strategies and improve customer experiences.    </p>
							<%--<p>Get Now
    ...
    <h2>DESCRIPTION</h2>
    <p>
      This website provides insights into customer feedback and market trends by analyzing user reviews from e-commerce platforms. It uses natural language processing (NLP) techniques to perform sentiment analysis, classifying reviews as positive, negative, or neutral. Additionally, the system leverages data analytics and visualization tools to predict product trends based on user sentiments, ratings, and review frequency over time.
    </p>
    <p>
      The goal of the website is to help businesses and customers make informed decisions. Businesses can track the performance and perception of their products, while customers can view sentiment-based ratings to guide their purchases. The site features an interactive dashboard, review analysis tools, trend graphs, and real-time data updates.
    </p>
  </div>
