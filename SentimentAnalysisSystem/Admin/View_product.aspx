...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form id="form1" runat="server">
      <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">View All Product</h3>
							<div class="row">
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="Product-Deatils.aspx?pname=<%#Eval("pname") %>" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
										</div>
								...
								<asp:SqlDataSource ID="SqlDataSource_pview" runat="server" 
                                    ...
                                    SelectCommand="SELECT * FROM [Add_Product] "></asp:SqlDataSource>
