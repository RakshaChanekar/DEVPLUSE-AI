<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="Product-Deatils.aspx.cs" Inherits="Admin_Product_Deatils" %>
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<%--		<div class="single-infoagile">
                    ...
                    <div class="right-w3l">
                            ...
                            <asp:Button ID="btnsubmit" runat="server" class="form-control" Text="Delete" 
                                onclick="btnsubmit_Click"  />
                               <asp:Button ID="btnedit" runat="server" class="form-control" Text="Update Stock" onclick="btnedit_Click"  />
                                <br />
                                <%--  <a href="Update_Product.aspx?pid=<%#Eval("pid") %>" class="btn-primary">Edit Product</a>--%>
                                  <br />
